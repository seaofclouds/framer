...
@git clone git://github.com/nex3/haml.git@<br />
@cd haml@<br />
@sudo rake install@<br />
@sudo gem install chriseppstein-compass --source=http://gems.github.com/@<br />
...
* "hampton catlin":http://hamptoncatlin.com for haml, sass and making my life so much easier.
